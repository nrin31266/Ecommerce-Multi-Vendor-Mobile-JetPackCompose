...
class GetOrderItemUseCase @Inject constructor(private val repo: Repo) {
    operator fun invoke( orderItem: Long): Flow<ResultState<OrderItemDto>>{
        return repo.getOrderItem(orderItem)
    }
}