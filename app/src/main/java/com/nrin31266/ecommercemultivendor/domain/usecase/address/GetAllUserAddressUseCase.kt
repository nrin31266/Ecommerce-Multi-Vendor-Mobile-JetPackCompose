...
class GetAllUserAddressUseCase @Inject constructor(private val repo: Repo) {
    operator fun invoke(): Flow<ResultState<List<AddressDto>>> {
        return repo.getAllUserAddresses()
    }
}