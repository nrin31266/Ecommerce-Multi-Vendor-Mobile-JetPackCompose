package com.nrin31266.ecommercemultivendor.domain.usecase.sellers
...
class GetSellerProfileUseCase @Inject constructor(private val repo: Repo) {
    operator fun invoke(jwt: String): Flow<ResultState<SellerDto>> {
        return repo.getSellerProfile(jwt)
    }
}