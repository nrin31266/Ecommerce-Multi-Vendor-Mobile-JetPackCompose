...
class GetFirstRatingUseCase @Inject constructor(
    private val repo: Repo
) {
    operator fun invoke(productId: Long): Flow<ResultState<List<ReviewDto>>> {
        return repo.getFirstReviewByProductId(productId)
    }
}
